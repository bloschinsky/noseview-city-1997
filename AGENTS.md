...
6. `src/engine/fuel.js`
7. `src/engine/navigation.js`
8. `src/engine/renderer.js`
9. `src/engine/signal-hunt.js`
10. `src/effects/analog-vision.js`
11. `src/effects/digital-rain.js`
12. `src/effects/starfield.js`
13. `src/effects/navigation-signal.js`
14. `src/audio/music.js`
15. `src/ui/hud.js`
16. `src/ui/controls.js`
17. `src/engine/engine.js`
18. `src/main.js`
